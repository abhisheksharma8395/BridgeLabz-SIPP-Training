...
public class DynamicMethodInvocation {
    public static void main(String[] args) {
        ...
        MathOperations1 mathOps = new MathOperations1();
        ...
        while (true) {
            ...
            try {
                ...
                Method[] methods = MathOperations1.class.getDeclaredMethods();
    ...
    public static void invokeMethod(MathOperations1 mathOps, Method method, Scanner scanner) {
        try {
