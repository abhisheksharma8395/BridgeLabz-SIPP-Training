package JavaReflectionsAndAnnotation;
...
class Product1 {
    ...
    public Product1(String name, double price, int quantity, boolean inStock, List<String> categories) {
        this.name = name;
        this.price = price;
...
class Customer {
    ...
    private Product1 favoriteProduct;
    
    public Customer(String id, String name, Address address, Product1 favoriteProduct) {
        this.id = id;
        this.name = name;
...
public class GenerateJSONRepresentation {
    ...
    public static void main(String[] args) {
        ...
        Product1 simpleProduct = new Product1();
        System.out.println("\n=== Empty Product JSON ===");
