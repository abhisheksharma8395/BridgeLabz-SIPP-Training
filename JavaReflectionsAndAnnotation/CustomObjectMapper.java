...
public class CustomObjectMapper {
    ...
    public static void main(String[] args) {
        ...
        Person1 person = toObject(Person1.class, personProps);
        ...
        Person1 partialPerson = toObject(Person1.class, partialProps);
        ...
        Person1 typeTestPerson = toObject(Person1.class, typeTest);
